...
make A=apps/c/wamr ARCH=aarch64 LOG=info run MUSL=y NET=y V9P=y V9P_PATH=apps/c/wamr/rootfs ARGS="iwasm,--env="TARGET=cpu",--dir=.,/tflite_bird.wasm,classifier_birds.tflite,bird.jpg" WASI_NN=1
```
